...
%%%%%%%%%% Referenzen %%%%%%%%%%%
\usepackage[style=numeric, bibencoding=utf8, backend=biber, sorting=none, maxbibnames=15]{biblatex}% für bibliographie, style=authortitle/numeric/ieee, backend=biber/bibtex/bibtex8, bibencoding=ascii/utf8
